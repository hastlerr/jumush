...
open class GrowingTextView: UITextView {
    ...
    private func commonInit() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(textDidEndEditing), name: UITextView.NSNotification.Name.UITextViewTextDidEndEditing, object: self)
    }
    ...
    open override var intrinsicContentSize: CGSize {
        return CGSize(width: UIView.UIViewNoIntrinsicMetric, height: 30)
    }
