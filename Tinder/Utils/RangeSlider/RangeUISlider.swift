...
@objc open class RangeUISlider: UIView {
    ...
    /// Scale minimum value.
    @IBInspectable public var scaleMinValue: CGFloat = 5
    /// Scale maximum value.
    @IBInspectable public var scaleMaxValue: CGFloat = 200
    ...
    @IBInspectable var disableRange: Bool = false {
        didSet {
            defaultValueLeftKnob = scaleMinValue
            defaultValueRightKnob = scaleMaxValue
            
            if disableRange{
                rightKnob.isUserInteractionEnabled = false
                rightKnob.isHidden = true
            }else{
                rightKnob.isUserInteractionEnabled = true
                rightKnob.isHidden = false
            }
    ...
    private func setup() {
        ...
        selectedProgressView.layer.cornerRadius = 5
        selectedProgressView.layer.masksToBounds = true
    }
